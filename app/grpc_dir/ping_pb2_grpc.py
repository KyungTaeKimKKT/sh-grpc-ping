...
import grpc_dir.ping_pb2 as ping__pb2
...
class PingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.CheckIPs = channel.unary_unary(
                '/ping.PingService/CheckIPs',
...
class PingServiceServicer(object):
    ...
    def CheckIPs(self, request, context):
        """Missing associated documentation comment in .proto file."""
...
def add_PingServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'CheckIPs': grpc.unary_unary_rpc_method_handler(
                    servicer.CheckIPs,
